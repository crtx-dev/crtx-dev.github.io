...
assert(html.includes('data-product="cortex"'),'generated redirect page missing product id');
assert(html.includes('data-default-port="7331"'),'generated redirect page missing default port');
